...
module OpenapiClient
  class TranscriptionOutputProduct
    attr_accessor :live

    # The vertical name
    attr_accessor :service_type

    # Language code. Format should be RFC 5646 Language code.
    ...
    def self.openapi_types
      {
        :'live' => :'TranscriptionOutputProductLive',
        :'service_type' => :'String',
        :'language' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::TranscriptionOutputProduct` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::TranscriptionOutputProduct`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      service_type_validator = EnumAttributeValidator.new('String', ["education", "corporate"])
    ...
    def service_type=(service_type)
      validator = EnumAttributeValidator.new('String', ["education", "corporate"])
    ...
    def hash
      [live, service_type, language].hash
    end
