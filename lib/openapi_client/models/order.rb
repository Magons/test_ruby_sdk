...
module OpenapiClient
  class Order
    ...
    def self.openapi_types
      {
        :'id' => :'String',
        :'status' => :'String',
        :'errors' => :'Array<OrderErrors>',
        :'details' => :'TranscriptionRequest'
      }
    end
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ["Pending", "Completed", "Failure", "Canceled", "In Progress"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["Pending", "Completed", "Failure", "Canceled", "In Progress"])
