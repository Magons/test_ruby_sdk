...
# Unit tests for OpenapiClient::WebsocketDelivery
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::WebsocketDelivery do
  let(:instance) { OpenapiClient::WebsocketDelivery.new }

  describe 'test an instance of WebsocketDelivery' do
    it 'should create an instance of WebsocketDelivery' do
      expect(instance).to be_instance_of(OpenapiClient::WebsocketDelivery)
    end
  end
