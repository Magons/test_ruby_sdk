...
# Unit tests for OpenapiClient::TranscriptionOutputProductLive
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TranscriptionOutputProductLive do
  let(:instance) { OpenapiClient::TranscriptionOutputProductLive.new }

  describe 'test an instance of TranscriptionOutputProductLive' do
    it 'should create an instance of TranscriptionOutputProductLive' do
      expect(instance).to be_instance_of(OpenapiClient::TranscriptionOutputProductLive)
    end
  end
  describe 'test attribute "tier"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["automatic", "professional"])
