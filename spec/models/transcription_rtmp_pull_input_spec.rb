...
# Unit tests for OpenapiClient::TranscriptionRtmpPullInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TranscriptionRtmpPullInput do
  let(:instance) { OpenapiClient::TranscriptionRtmpPullInput.new }

  describe 'test an instance of TranscriptionRtmpPullInput' do
    it 'should create an instance of TranscriptionRtmpPullInput' do
      expect(instance).to be_instance_of(OpenapiClient::TranscriptionRtmpPullInput)
    end
  end
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["rtmp_pull"])
