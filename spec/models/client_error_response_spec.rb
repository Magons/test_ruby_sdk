...
# Unit tests for OpenapiClient::ClientErrorResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ClientErrorResponse do
  let(:instance) { OpenapiClient::ClientErrorResponse.new }

  describe 'test an instance of ClientErrorResponse' do
    it 'should create an instance of ClientErrorResponse' do
      expect(instance).to be_instance_of(OpenapiClient::ClientErrorResponse)
    end
  end
