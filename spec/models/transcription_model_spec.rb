...
# Unit tests for OpenapiClient::TranscriptionModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TranscriptionModel do
  let(:instance) { OpenapiClient::TranscriptionModel.new }

  describe 'test an instance of TranscriptionModel' do
    it 'should create an instance of TranscriptionModel' do
      expect(instance).to be_instance_of(OpenapiClient::TranscriptionModel)
    end
  end
  describe 'test attribute "name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["education", "legal", "finance", "general_purpose"])
