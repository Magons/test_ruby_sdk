...
# Unit tests for OpenapiClient::TranscriptionSchedule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TranscriptionSchedule do
  let(:instance) { OpenapiClient::TranscriptionSchedule.new }

  describe 'test an instance of TranscriptionSchedule' do
    it 'should create an instance of TranscriptionSchedule' do
      expect(instance).to be_instance_of(OpenapiClient::TranscriptionSchedule)
    end
  end
