...
# Unit tests for OpenapiClient::TranscriptionRtmpPushInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TranscriptionRtmpPushInput do
  let(:instance) { OpenapiClient::TranscriptionRtmpPushInput.new }

  describe 'test an instance of TranscriptionRtmpPushInput' do
    it 'should create an instance of TranscriptionRtmpPushInput' do
      expect(instance).to be_instance_of(OpenapiClient::TranscriptionRtmpPushInput)
    end
  end
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["rtmp_push"])
