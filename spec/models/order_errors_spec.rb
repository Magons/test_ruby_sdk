...
# Unit tests for OpenapiClient::OrderErrors
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::OrderErrors do
  let(:instance) { OpenapiClient::OrderErrors.new }

  describe 'test an instance of OrderErrors' do
    it 'should create an instance of OrderErrors' do
      expect(instance).to be_instance_of(OpenapiClient::OrderErrors)
    end
  end
