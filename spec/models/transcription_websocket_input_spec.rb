...
# Unit tests for OpenapiClient::TranscriptionWebsocketInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TranscriptionWebsocketInput do
  let(:instance) { OpenapiClient::TranscriptionWebsocketInput.new }

  describe 'test an instance of TranscriptionWebsocketInput' do
    it 'should create an instance of TranscriptionWebsocketInput' do
      expect(instance).to be_instance_of(OpenapiClient::TranscriptionWebsocketInput)
    end
  end
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["websocket"])
