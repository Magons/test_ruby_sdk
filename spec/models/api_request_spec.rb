...
# Unit tests for OpenapiClient::ApiRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ApiRequest do
  let(:instance) { OpenapiClient::ApiRequest.new }

  describe 'test an instance of ApiRequest' do
    it 'should create an instance of ApiRequest' do
      expect(instance).to be_instance_of(OpenapiClient::ApiRequest)
    end
  end
