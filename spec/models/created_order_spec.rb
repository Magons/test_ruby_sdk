...
# Unit tests for OpenapiClient::CreatedOrder
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CreatedOrder do
  let(:instance) { OpenapiClient::CreatedOrder.new }

  describe 'test an instance of CreatedOrder' do
    it 'should create an instance of CreatedOrder' do
      expect(instance).to be_instance_of(OpenapiClient::CreatedOrder)
    end
  end
