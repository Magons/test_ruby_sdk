...
# Unit tests for OpenapiClient::ServerErrorResponseAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ServerErrorResponseAllOf do
  let(:instance) { OpenapiClient::ServerErrorResponseAllOf.new }

  describe 'test an instance of ServerErrorResponseAllOf' do
    it 'should create an instance of ServerErrorResponseAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::ServerErrorResponseAllOf)
    end
  end
