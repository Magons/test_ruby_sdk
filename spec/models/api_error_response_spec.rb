...
# Unit tests for OpenapiClient::ApiErrorResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ApiErrorResponse do
  let(:instance) { OpenapiClient::ApiErrorResponse.new }

  describe 'test an instance of ApiErrorResponse' do
    it 'should create an instance of ApiErrorResponse' do
      expect(instance).to be_instance_of(OpenapiClient::ApiErrorResponse)
    end
  end
