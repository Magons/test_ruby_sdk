...
# Unit tests for OpenapiClient::TranscriptionOutput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TranscriptionOutput do
  let(:instance) { OpenapiClient::TranscriptionOutput.new }

  describe 'test an instance of TranscriptionOutput' do
    it 'should create an instance of TranscriptionOutput' do
      expect(instance).to be_instance_of(OpenapiClient::TranscriptionOutput)
    end
  end
