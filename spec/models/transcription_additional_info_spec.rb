...
# Unit tests for OpenapiClient::TranscriptionAdditionalInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TranscriptionAdditionalInfo do
  let(:instance) { OpenapiClient::TranscriptionAdditionalInfo.new }

  describe 'test an instance of TranscriptionAdditionalInfo' do
    it 'should create an instance of TranscriptionAdditionalInfo' do
      expect(instance).to be_instance_of(OpenapiClient::TranscriptionAdditionalInfo)
    end
  end
