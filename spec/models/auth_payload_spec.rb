...
# Unit tests for OpenapiClient::AuthPayload
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::AuthPayload do
  let(:instance) { OpenapiClient::AuthPayload.new }

  describe 'test an instance of AuthPayload' do
    it 'should create an instance of AuthPayload' do
      expect(instance).to be_instance_of(OpenapiClient::AuthPayload)
    end
  end
