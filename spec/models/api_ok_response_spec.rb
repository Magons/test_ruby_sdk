...
# Unit tests for OpenapiClient::ApiOkResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ApiOkResponse do
  let(:instance) { OpenapiClient::ApiOkResponse.new }

  describe 'test an instance of ApiOkResponse' do
    it 'should create an instance of ApiOkResponse' do
      expect(instance).to be_instance_of(OpenapiClient::ApiOkResponse)
    end
  end
