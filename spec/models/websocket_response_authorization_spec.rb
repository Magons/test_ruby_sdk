...
# Unit tests for OpenapiClient::WebsocketResponseAuthorization
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::WebsocketResponseAuthorization do
  let(:instance) { OpenapiClient::WebsocketResponseAuthorization.new }

  describe 'test an instance of WebsocketResponseAuthorization' do
    it 'should create an instance of WebsocketResponseAuthorization' do
      expect(instance).to be_instance_of(OpenapiClient::WebsocketResponseAuthorization)
    end
  end
