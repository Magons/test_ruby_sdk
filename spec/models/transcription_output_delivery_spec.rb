...
# Unit tests for OpenapiClient::TranscriptionOutputDelivery
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TranscriptionOutputDelivery do
  let(:instance) { OpenapiClient::TranscriptionOutputDelivery.new }

  describe 'test an instance of TranscriptionOutputDelivery' do
    it 'should create an instance of TranscriptionOutputDelivery' do
      expect(instance).to be_instance_of(OpenapiClient::TranscriptionOutputDelivery)
    end
  end
