...
# Unit tests for OpenapiClient::TranscriptionRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TranscriptionRequest do
  let(:instance) { OpenapiClient::TranscriptionRequest.new }

  describe 'test an instance of TranscriptionRequest' do
    it 'should create an instance of TranscriptionRequest' do
      expect(instance).to be_instance_of(OpenapiClient::TranscriptionRequest)
    end
  end
