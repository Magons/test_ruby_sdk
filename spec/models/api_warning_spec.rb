...
# Unit tests for OpenapiClient::ApiWarning
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ApiWarning do
  let(:instance) { OpenapiClient::ApiWarning.new }

  describe 'test an instance of ApiWarning' do
    it 'should create an instance of ApiWarning' do
      expect(instance).to be_instance_of(OpenapiClient::ApiWarning)
    end
  end
