...
# Unit tests for OpenapiClient::ClientErrorResponseAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ClientErrorResponseAllOf do
  let(:instance) { OpenapiClient::ClientErrorResponseAllOf.new }

  describe 'test an instance of ClientErrorResponseAllOf' do
    it 'should create an instance of ClientErrorResponseAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::ClientErrorResponseAllOf)
    end
  end
