...
# Unit tests for OpenapiClient::OutputResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::OutputResponse do
  let(:instance) { OpenapiClient::OutputResponse.new }

  describe 'test an instance of OutputResponse' do
    it 'should create an instance of OutputResponse' do
      expect(instance).to be_instance_of(OpenapiClient::OutputResponse)
    end
  end
