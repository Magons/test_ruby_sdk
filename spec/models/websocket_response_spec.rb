...
# Unit tests for OpenapiClient::WebsocketResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::WebsocketResponse do
  let(:instance) { OpenapiClient::WebsocketResponse.new }

  describe 'test an instance of WebsocketResponse' do
    it 'should create an instance of WebsocketResponse' do
      expect(instance).to be_instance_of(OpenapiClient::WebsocketResponse)
    end
  end
